...
3. **Vérifiez le système extrait.** S'il se trompe d'une couleur ou d'une police, corrigez
   ...
   - Bleu Principal `#1D257A` · Chamois `#B0AD85` · Fond `#F9F9F9` (+ secondaires émeraude/rose/indigo)
...
- « Une **carte Proposition 5 – ÉCOLE**, format 1080×1350. Accroche : *Rendons à l'école son
  autorité et son exigence*. 3 mesures, mot-clé en chamois : (1) uniforme et respect du
...
- « Une **couverture** sur fond bleu : *La France a les talents. Donnons-leur les moyens.*,
  'talents' en chamois. Comme `exemples-visuels/couverture-genie.jpg`. »
...
Puis **affinez** visuellement (« agrandis le titre », « mets ce mot en chamois », « plus d'air
en bas »).
...
- Vérifiez sur 1–2 essais que **logo, polices et bleu `#1D257A`** sont bien respectés avant
